...
Following separation of concerns - styling and presentation logic separated from business logic.
"""
...
SECTION_TEMPLATES = {
    ...
    "report_details": """<div class="section">
    ...
    "metrics_dashboard": """<div class="section">
    <h2>📊 Metric Dashboard</h2>
    <div class="dashboard">
{metric_cards}
    </div>
</div>""",
    "trend_chart": """<div class="section">
